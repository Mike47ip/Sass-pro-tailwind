   ...
   <div className="flex justify-center flex-col  items-center lg:flex-row gap-9 lg:gap-0 lg:pt-[140px] lg:right-[3%] relative">
    ...
    <div className="flex flex-col items-start">
     ...
     <div className="px-20 lg:px-0 lg:pl-4 xl:pl-7">
      ...
      <button className="flex text-lg items-center gap-2 font-bold mb-5 border-2 border-black border-solid rounded-2xl px-6 py-3 hover:bg-black hover:text-white">
       Watch how it works
      </button>
     </div>
    </div>
